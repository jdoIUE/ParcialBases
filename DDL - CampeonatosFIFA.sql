...
BEGIN
    ...
    -- Insertar solo los que no están duplicados (independientemente del orden de los países)
    ...
    IF @@ROWCOUNT = 0
    BEGIN
        RAISERROR ('El partido ya está registrado en esta fase y campeonato.', 16, 1);
    END
END;
GO
